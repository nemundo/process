...
class PodcastEpisodeExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
$this->externalModelClassName = PodcastEpisodeModel::class;
$this->externalTableName = "podcast_podcast_episode";
...
$this->podcast = new \Nemundo\Process\App\Podcast\Data\Podcast\PodcastExternalType(null, $this->parentFieldName . "_podcast");
