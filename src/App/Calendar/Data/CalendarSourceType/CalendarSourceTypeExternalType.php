...
class CalendarSourceTypeExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
$this->externalModelClassName = CalendarSourceTypeModel::class;
$this->externalTableName = "calendar_calendar_source_type";
