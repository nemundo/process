...
class UserAssignmentLogExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
$this->externalModelClassName = UserAssignmentLogModel::class;
$this->externalTableName = "template_user_assignment_log";
